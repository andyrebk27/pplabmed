        ...
        <form id="HistopatologiaForm" class="form-horizontal" method="POST" role="form">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="Finforme" class="col-md-3 control-label">Fecha Informe:</label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="FBiopsia" class="col-md-3 control-label">Fecha Biopsia:</label>
                            <div class="col-md-7" style="padding-left: 2px; padding-right: 2px;">
                ...
                <div class="form-group">
                    <div class="col-md-10 col-lg-offset-2">
                        ...
                        <a id="btn-guardar" type="submit" href="#" class="btn btn-primary" onclick="guardarHistopatologia();">Guardar</a> 
                    </div>
                </div>         
            </fieldset>
            <div class="row">
