...
<div id="pagina" style="/* background-color: black; */">
    <div class="well bs-component">
        <form id="CitologiaForm" class="form-horizontal" method="POST" role="form">
            <fieldset>
                <legend>Agregar Citología<div class="row" style="border-top: 1px dotted #c5daea;display: block;margin: 10px 0;"></div></legend>
                <div class="row">
                    <br/>
                    <!-- campos hansa -->
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="col-md-10 col-lg-offset-2">
                        ...
                        <a id="btn-guardar" type="submit" href="#" class="btn btn-primary" onclick="guardarCitologia();;">Guardar</a> 
                    </div>
                </div>
            </fieldset>
            <div class="row">
